  ...
  return (
    <div className="space-y-6">
      ...
      {stats.currentSession && (
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg p-6 shadow-xl">
                ...
                {stats.currentSession.openTabs.map((tab: any) => (
                  <div 
                    ...
                    className={`flex items-center justify-between text-sm rounded px-3 py-2 ${
                      tab.active ? 'bg-green-500/20 border border-green-500/30' : 'bg-white/5'
                    }`}
                  >
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <div className="bg-gradient-to-br from-pink-600 to-pink-700 rounded-lg p-6 shadow-xl">
